...
@WebServlet(name = "ListAllCategoriesServlet", urlPatterns = {"/ListAllCategoriesServlet"})
public class ListAllCategoriesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Categories> result = controller.findCategoriesEntities();
            request.setAttribute("LIST_RESULT", result);
        } catch (Exception ex) {
            String message = ex.getMessage();
            log("ListAllCategoriesServlet _ Exception " + message);
        } finally {
