...
public class SearchCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Categories> allCategories = controller.findCategoriesEntities();
            List<Categories> result = new ArrayList<>();
            for(Categories category: allCategories){
                if(category.getCategoryName().contains(searchValue)){
                    result.add(category);
                }
            }
            ...
            log("SearchCategoryServlet _ Exception " + message);
        } finally {
