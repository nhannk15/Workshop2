...
public class UpdateProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Date postedDate = Date.from(ldt.atZone(ZoneId.systemDefault()).toInstant());
        ...
        try {
            ...
            Products newProduct = controller.findProducts(productId);

            newProduct.setProductName(productName);
            newProduct.setProductImage(productImage);
            newProduct.setBrief(brief);
            ...
            controller.edit(newProduct);
        } catch (IllegalOrphanException ex) {
            String message = ex.getMessage();
            log("UpdateProductServlet _ IllegalOrphanException " + message);
        } catch (Exception ex) {
            String message = ex.getMessage();
            log("UpdateProductServlet _ Exception " + message);
        }
