...
@WebServlet(name = "SearchProductUsingNameServlet", urlPatterns = {"/SearchProductUsingNameServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (Products product: allProducts) {
                if(product.getProductName().contains(searchValue)) {
                    result.add(product);
                }
            }
            ...
            log("SearchProductUsingNameServlet _ Exception " + message);
        } finally {
