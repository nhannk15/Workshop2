...
@WebServlet(name = "LoadUpdateAccountServlet", urlPatterns = {"/LoadUpdateAccountServlet"})
public class LoadUpdateAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Accounts targetAccount = controller.findAccounts(account);
            if(targetAccount != null) {
                request.setAttribute("ACCOUNT_INFO", targetAccount);
            }
        } catch (Exception ex) {
            String message = ex.getMessage();
            log("LoadUpdateAccountServlet _ " + message);
        } finally {
