...
@WebServlet(name = "ListAllProductsServlet", urlPatterns = {"/ListAllProductsServlet"})
public class ListAllProductsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductsJpaController productController = 
                    new ProductsJpaController(JPAUtils.getEntityManagerFactory());
            List<Products> result = productController.findProductsEntities();
