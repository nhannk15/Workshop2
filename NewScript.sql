-- THIS SCRIPT ALSO CHANGES THE OLD SCRIPT'S CODE LINE
-- IF YOU WANT TO USE THE OLD ONE (WITHOUT THE NEW TWO TABLES AND RELATIONS), 
-- I'VE ALREADY PUT IT IN MY .RAR FOLDER.
-- THANKS!
...
ALTER DATABASE ProductIntro SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
go
